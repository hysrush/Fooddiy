								...
								<div class="tab-pane active" id="tabsNavigationSimple1">
									<div class="center">
										...
										<form:form commandName="snsVO" method="POST"  name="csForm" id="csForm" enctype="multipart/form-data">
												<form:input path ="name" name="name"  id="name" type="hidden"  value="${snsVO.name}" readonly="readonly" />
												<form:input path ="bread" name="bread"  id="bread" type="hidden" value="${snsVO.bread}" readonly="readonly" />
												<form:input path ="cheese" name="cheese"  id="cheese" type="hidden" value="${snsVO.cheese}" readonly="readonly" />
												<form:input path ="topping" name="topping"  id="topping" type="hidden" value="${snsVO.topping}" readonly="readonly" />
												<form:input path ="vegetable" name="vegetable"  id="vegetable" type="hidden" value="${snsVO.vegetable}" readonly="readonly" />
												<form:input path ="sauce" name="sauce"  id="sauce" type="hidden"  value="${snsVO.sauce}" readonly="readonly" />	
														...
														<td>
															<div class="file_BasicSection">
																<div class="fileDiv col-md-12" id="fileDiv1" >
																	...
																	<form:input path="fileName" type="file" class="file_input form-control" id="fileName" name="fileName" placeholder="파일첨부" value = "${snsVO.fileName }" style="float: left; width: 70%;"/>&nbsp;&nbsp;
															...
															<div class="col-md-12" style="float: left;">
																<div class="order col-md-6" style="float: left;">
																	<div class="input-group date col-md-12" data-toggle="modal" data-target="#formModal">
																		<input type="text" class="form-control" readonly="readonly" placeholder="주문내역"  value ="${snsVO.name}" name="orderList" id="orderList"/>
