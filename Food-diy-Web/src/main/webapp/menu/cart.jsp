										...
										<table class="cart-table">
											...
											<tbody>
												<tr>
													...
													<td class="product-image-td"><a href="#" title="Product Name"> <img src="../img/demos/shop/products/cart-product1.jpg" alt="Product Name">
													</a></td>
													<td class="product-name-td">
														<h2 class="product-name">
															<a href="#" title="Product Name">Women Fashion Blouse</a>
														</h2>
													</td>
													<td>$120.00</td>
													<td>
													...
													<td><span class="text-primary">$120.00</span></td>
												</tr>
												<tr>
													<td class="product-action-td"><a href="#" title="Remove product" class="btn-remove"><i class="fa fa-times"></i></a></td>
