						...
						<div class="col-xs-12">
							<div class="panel-group panel-group-lg" id="accordion5">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion5" href="#collapse55Two">
												치즈 선택 >>
											</a>
										</h4>
									</div>
									<div id="collapse55Two" class="accordion-body collapse">
										<div class="panel-body">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion5" href="#sauce">
												소스 선택 >>
											</a>
										</h4>
									</div>
									<div id="sauce" class="accordion-body collapse">
										<div class="panel-body">
