				...
				<div id="revolutionSlider" class="slider rev_slider manual revslider-initialised tp-simpleresponsive" style="margin-top: 0px; margin-bottom: 0px; height: 261px;" data-slideactive="rs-844971">
					<ul class="tp-revslider-mainul" style="visibility: visible; display: block; overflow: hidden; width: 595px; height: 100%; max-height: none; left: 0px;">
						<li data-transition="fade" class="tp-revslider-slidesli active-revslide" style="width: 100%; height: 100%; overflow: hidden; z-index: 20; visibility: inherit; opacity: 1; background-color: rgba(255, 255, 255, 0);">
							<div class="slotholder" style="position: absolute; top: 0px; left: 0px; z-index: 0; width: 100%; height: 100%; visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
								...
								<div class="tp-bgimg defaultimg "
									style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url(&quot;${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/slide1.jpg&quot;); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit; z-index: 20;"
									src="${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/slide1.jpg"></div>
							</div>
								...
								<div class="tp-loop-wrap" style="position: absolute; display: block;">
									<div class="tp-mask-wrap" style="position: absolute; display: block; overflow: visible;">
										<div class="tp-caption" data-x="center" data-y="top" data-start="1200" data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:1000;"
											...
											id="layer-766013703">
											<img src="${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/item1.png" alt="Item" style="width: 595px; height: 260.965px;">
										</div>
									</div>
								</div>
							</div>
						...
						<li data-transition="fade" class="tp-revslider-slidesli" style="width: 100%; height: 100%; overflow: hidden; z-index: 18; visibility: hidden; opacity: 0; background-color: rgba(255, 255, 255, 0);">
							<div class="slotholder" style="position: absolute; top: 0px; left: 0px; z-index: 0; width: 100%; height: 100%; visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
								<!--Runtime Modification - Img tag is Still Available for SEO Goals in Source - <img src="${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/slide2.jpg" alt="slide bg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg defaultimg">-->
								<div class="tp-bgimg defaultimg "
									style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url(&quot;${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/slide2.jpg&quot;); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit; z-index: 20;"
									src="${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/slide2.jpg"></div>
							</div>
								...
								<div class="tp-loop-wrap" style="position: absolute; display: block;">
									<div class="tp-mask-wrap" style="position: absolute; display: block; overflow: visible;">
										<div class="tp-caption" data-x="center" data-y="top" data-start="1200" data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:1000;"
											...
											id="layer-87625021">
											<img src="${ pageContext.request.contextPath }/resources/img/demos/shop/slides/shop9/item2.png" alt="Item" style="width: 595px; height: 260.965px;">
										</div>
									</div>
								</div>
							</div>
